Feature: New User Registration Success
  ...
  Scenario: Navigate to signup page and enter user credentials
    ...
    When I enter a unique name "Sobat Testing" and valid email address "test.agent_01@test.org"
  ...
  @poc
  Scenario: Fill account and address information
    Given I am on the signup form using name "testAgent01" and email "test.agent01@test.org"
    ...
    And I fill in first name "Jhonny" and last name "Walker"
...
#  @poc
#  Scenario: Post-registration redirect to home page
#    Given I am on the Account Created page
